...
function glMain() {
    ...
    var fonts_select = document.getElementById("font-select");
    ...
    roboto_font.tex = loadTexture(gl, "/webgl/fonts/roboto.png", gl.LUMINANCE, false);
    roboto_bold_font.tex = loadTexture(gl, "/webgl/fonts/roboto-bold.png", gl.LUMINANCE, false);
    ubuntu_font.tex = loadTexture(gl, "/webgl/fonts/ubuntu.png", gl.LUMINANCE, false, true);
    ubuntu_bold_font.tex = loadTexture(gl, "/webgl/fonts/ubuntu-bold.png", gl.LUMINANCE, false);
    dejavu_font.tex = loadTexture(gl, "/webgl/fonts/dejavu-serif.png", gl.LUMINANCE, false);
    dejavu_italic_font.tex = loadTexture(gl, "/webgl/fonts/dejavu-serif-italic.png", gl.LUMINANCE, false);
    ...
    function render() {
        ...
        //console.log('gl.TRIANGLES, 0, vcount :', gl.TRIANGLES, 0, vcount)
